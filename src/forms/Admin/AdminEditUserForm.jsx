...
function AdminEditUserForm({user, account}) {
    let errs = {}
    let initialFlash = {}
    let initialForm = {
        firstName: "",
    ...
    const isComplete = () => {
        ...
        if (formData.password2 && (formData.password2.length < 5 || formData.password2.length > 20))  {
            return false;
        }
    ...
    return (
        ...
        <Form className="form">
          ...
          <FormGroup>
            {flashMsg.passwordErr && <p className="FlashMsg-error">{flashMsg.passwordErr}</p>}
